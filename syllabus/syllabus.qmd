...
- 時間：2025年8月15〜16、18〜20日 3〜5限目
   - 2日目（8月16日[土]）は**オンデマンド**で実施
- 教室：フロンティア館 303教室
...
- 授業貢献度：30%
   - 授業への参加度、質問など
- 期末レポート：70%
   - 期末レポートの内容は初回の授業で案内する

## 履修上の注意

　統計学に関する基礎知識が必要である。目安は母平均の差の検定、および線形回帰分析が理解でき、統計ソフトウェアで実行・解釈が可能なレベルである。

　本講義における共通言語はRである。Rの使い方に関しては既にインターネット上に膨大な情報がある。[宋](https://www.jaysong.net)と[矢内](https://yukiyanai.github.io/)（高知工科大学）が執筆中の以下の資料を参照することも1つの選択肢である。
