...
* 電卓としてのRの使い方
   ...
   * 2日目にRの解説は行うが、深入りはしない(できない)
      * <https://www.jaysong.net/micro-book/> $\leftarrow$ これくらいは知っておけば2日目の内容を省略し、5日目に操作変数法について解説
...
::: {.r-stack}
![](figs/01/Game_Height1.png){width=60% fig-align="center"}

![](figs/01/Game_Height2.png){.fragment width=60% fig-align="center"}
:::
