...
#| fig-height: 3.2
#| cache: true
bind_rows(list(broom::tidy(poly_fit1, conf.int = TRUE),
               broom::tidy(poly_fit2, conf.int = TRUE),
               broom::tidy(poly_fit3, conf.int = TRUE),
               broom::tidy(poly_fit4, conf.int = TRUE),
               broom::tidy(poly_fit5, conf.int = TRUE),
               broom::tidy(poly_fit6, conf.int = TRUE),
               broom::tidy(poly_fit7, conf.int = TRUE),
               broom::tidy(poly_fit8, conf.int = TRUE),
               broom::tidy(poly_fit9, conf.int = TRUE),
               broom::tidy(poly_fit10, conf.int = TRUE)),
          .id = "Model") |>
